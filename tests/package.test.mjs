...
test('package metadata exposes the host and browser plugins', async () => {
  ...
  assert.equal(manifest.peerDependencies['@deepseek-ai/dsh-api-remotes'], '0.1.0-rc.8')
  assert.equal(manifest.peerDependencies['@deepseek-ai/dsh-client-runtime'], '0.1.0-rc.8')
  assert.equal(manifest.peerDependencies['@deepseek-ai/dsh-client-ui-settings-models'], '0.1.0-rc.8')
  assert.equal(manifest.peerDependencies['@deepseek-ai/dsh-settings'], '0.1.0-rc.8')
